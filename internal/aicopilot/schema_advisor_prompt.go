...
func BuildSchemaAdvisorPrompt(payload SchemaAdvisorPayload) (string, error) {
	...
	b.WriteString("Avoid causal-certainty wording: do not use the exact phrase root cause, even in negated sentences; do not use proves, definitely, certainly, must be caused by, or is caused by.\n")
