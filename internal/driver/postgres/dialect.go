...
- Column and table names MUST preserve the EXACT characters from the source name, only lowercased
- Do NOT abbreviate, shorten, remove underscores, or modify names in any way
